...
import org.example.employeemanagement.dto.people.requests.AddressRequest;
import org.example.employeemanagement.dto.people.UserResponse;
import org.example.employeemanagement.repositories.people.AddressRepository;
...
public class AddressService {
    ...
    public UserResponse getDetails(String email) {
        ...
        dto.setCompanyPermissions(person.getCompanyPermissions());
        dto.setOrganisationPermissions(person.getOrganizationPermissions());
        dto.setUnitPermissions(person.getUnitPermissions());
